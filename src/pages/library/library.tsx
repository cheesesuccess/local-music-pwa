...
const NavButton = (props: LibraryPageConfig) => (
  <NavLink activeClass={styles.navBtnSelected} class={styles.navBtn} href={props.path} replace>
    <Icon icon={props.icon} />
  </NavLink>
)

const NavigationButtons = (props: { type: 'rail' | 'bottom' | 'tabs' }) => (
...
const Library = (): JSXElement => {
  ...
  return (
    <Scaffold
      ...
      topBar={<TopBar tabs={isMedium() && !IS_DEVICE_A_MOBILE && <NavigationButtons type='tabs' />} />}
